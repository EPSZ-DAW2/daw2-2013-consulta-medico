...
class AseguradorasController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Aseguradoras'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idAseguradora));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Aseguradoras');
	...
	{
		$model=new Aseguradoras('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Aseguradoras']))
			$model->attributes=$_GET['Aseguradoras'];
	 ...
	 * @param Aseguradoras $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='aseguradoras-form')
		{
